...
static int io_init( void ) {
    _io_di_pin[0] = GET_PIN(D, 12);
    _io_di_pin[1] = GET_PIN(D, 13);
    _io_di_pin[2] = GET_PIN(E, 0);
    _io_di_pin[3] = GET_PIN(C, 6);
    _io_di_pin[4] = GET_PIN(C, 7);
    _io_di_pin[5] = GET_PIN(E, 1);
    _io_di_pin[6] = GET_PIN(B, 4);
    _io_di_pin[7] = GET_PIN(B, 5);
    _io_di_pin[8] = GET_PIN(E, 8);
    _io_di_pin[9] = GET_PIN(E, 10);
    _io_di_pin[10] = GET_PIN(E, 9);
    _io_di_pin[11] = GET_PIN(E, 11);
    _io_di_pin[12] = GET_PIN(E, 12);
    _io_di_pin[13] = GET_PIN(E, 13);

    _io_do_pin[0] = GET_PIN(A, 0);
    _io_do_pin[1] = GET_PIN(A, 1);
    _io_do_pin[2] = GET_PIN(D, 0);
    _io_do_pin[3] = GET_PIN(D, 1);
    _io_do_pin[4] = GET_PIN(D, 2);
    _io_do_pin[5] = GET_PIN(D, 3);
    _io_do_pin[6] = GET_PIN(D, 4);
    _io_do_pin[7] = GET_PIN(B, 7);
    _io_do_pin[8] = GET_PIN(C, 0);
    _io_do_pin[9] = GET_PIN(C, 1);
